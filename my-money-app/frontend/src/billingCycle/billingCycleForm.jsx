...
import labelAndIinput from '../common/form/labelAndIinput'
        ...
        return (
            ...
            <form role="form" onSubmit={handleSubmit}>
                <div className="box-body">
                    <Field name="name" component={labelAndIinput} readOnly={readOnly}
                        label="Nome" cols="12 4" placeholder="Informe seu nome"/> 
                    <Field name="month" component={labelAndIinput} readOnly={readOnly}
                        label="Mês" cols="12 4" type="number" placeholder="Informe o mês"/>
                    <Field name="year" component={labelAndIinput} readOnly={readOnly}
